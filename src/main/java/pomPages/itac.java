...
public class itac {
	...
	@FindBy(xpath = "//span[text()='ITAC']")
    private WebElement itac;
    ...
    private WebElement saveITACRuleSet;
        ...
        try {
            ...
            if (popup.isDisplayed()) {
                if (popupText.contains("Choose One")) {
                    wait.until(ExpectedConditions.elementToBeClickable(itac)).click();
                } else{
	...
	public WebElement getSaveITACRuleSet() {
		return saveITACRuleSet;
	}
